...
import com.mss.web.domain.Task;
import com.mss.web.repository.TaskRepository;
...
public class TaskResourceIntTest {
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getTask()).isEqualTo(DEFAULT_TASK);
    ...
    public void updateTask() throws Exception {
        ...
        Task testTask = taskList.get(taskList.size() - 1);
        assertThat(testTask.getTask()).isEqualTo(UPDATED_TASK);
